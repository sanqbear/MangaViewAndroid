...
public class MainPage {
    ...
    void fetch(CustomHttpClient client) {
         ...
         * 
         * Elements list =
         * doc.selectFirst("div.msm-post-gallery").select("div.post-row");
         * for(Element e:list){
    ...
    public static class RankingTitle extends Title {
        ...
        public RankingTitle(String n, String t, String a, List<String> tg, String r, int id, int baseMode,
                int ranking) {
    ...
    public List<RankingTitle> getRanking() {
        return ranking;
    }
}
