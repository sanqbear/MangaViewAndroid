...
public class AdvSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(v -> {
            String query = "search_type=" + (searchMethod.getSelectedItemPosition() + 1) + "&_0=" + input.getText()
                    + "&_1=" + na.getSelectedIndex() + "&_2=" + ra.getSelectedIndex() + "&_3=" + ta.getSelectedValues()
                    + "&_4=" + sortMethod.getSelectedItemPosition();
